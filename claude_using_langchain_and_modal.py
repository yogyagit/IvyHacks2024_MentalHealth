...
stub = Stub(
    ...
    image=image,
    secrets=[Secret.from_name("my-claude-secret"),Secret.from_name("my-openai-secret")],
)
...
def qanda_langchain(query: str) -> tuple[str, list[str]]:
    ...
    chain = load_qa_with_sources_chain(
        ...
        ##AG    OpenAI(model_name="gpt-3.5-turbo-instruct", temperature=0),
        chain_type="stuff",
    )
